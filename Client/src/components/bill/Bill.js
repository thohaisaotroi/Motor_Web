    ...
    return (
        ...
        >
            ...
            <div className="flex text-start mx-8 justify-between">
                {/* Billing Information */}
                <div className="mb-8">
                    <h2 className="text-lg font-semibold mb-2">GHI HÓA ĐƠN ĐẾN:</h2>
                ...
                <div className="text-right">
                    <p className="text-sm">Số Hóa Đơn: {orderId}</p>
                    <p className="text-sm">Ngày: {createDate}</p>
                </div>
            </div>
            ...
            <div className="flex justify-between mb-8">
                ...
                <div className="flex-col">
                    <div className="flex mb-1">
                        <p className="text-lg mr-1 font-bold">Tạm Tính:</p>
            ...
            <div className="flex flex-col mx-8 text-start">
                ...
                <p className="text-sm">Ngân hàng: VCD</p>
                <p className="text-sm">Tên Tài Khoản: CatDaBlack</p>
                <div className="flex justify-between">
                    <div className="flex-col">
                        <p className="text-sm">Số Tài Khoản: 123-456-7890</p>
                        <p className="text-sm">Thanh Toán vào: {createDate}</p>
                    </div>
                    <div className="flex-col">
